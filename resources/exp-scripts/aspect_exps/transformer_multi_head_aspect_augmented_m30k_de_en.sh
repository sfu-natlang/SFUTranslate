...
python aspect_extract_main.py ../../../resources/exp-configs/aspect_exps/transformer_multi_head_aspect_augmented_multi30k_de_en.yml 2>train_aspect_extractor.log >train_aspect_extractor.output
cd ../../ || return
...
python trainer.py ../resources/exp-configs/aspect_exps/transformer_multi_head_aspect_augmented_multi30k_de_en.yml 2>train_progress_bars.log >train.output
...
python test_trained_model.py ../resources/exp-configs/aspect_exps/transformer_multi_head_aspect_augmented_multi30k_de_en.yml 2>testerr.log >test.output
