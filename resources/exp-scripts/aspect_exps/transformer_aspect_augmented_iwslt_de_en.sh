...
python trainer.py ../resources/exp-configs/aspect_exps/transformer_aspect_augmented_iwslt_de_en.yml 2>train_progress_bars.log >train.output
...
python test_trained_model.py ../resources/exp-configs/aspect_exps/transformer_aspect_augmented_iwslt_de_en.yml 2>testerr.log >test.output
