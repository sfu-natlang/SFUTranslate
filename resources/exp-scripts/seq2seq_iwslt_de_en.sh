...
cd translate/ || return
python trainer.py ../resources/exp-configs/seq2seq_de_en.yml 2>train_progress_bars.log >train.output
python test_trained_model.py ../resources/exp-configs/seq2seq_de_en.yml 2>testerr.log >test.output
