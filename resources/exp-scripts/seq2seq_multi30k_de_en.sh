...
git checkout e0dcc20c8919c32e84b1127ed1972e533416a337
...
python trainer.py ../resources/exp-configs/seq2seq_multi30k_de_en.yml 2>train_progress_bars.log >train.output
...
python test_trained_model.py ../resources/exp-configs/seq2seq_multi30k_de_en.yml 2>testerr.log >test.output
