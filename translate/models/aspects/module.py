...
This is the implementation of all necessary modules required for aspects package including:
 ...
 - Syntax-Infused Information Container: a container class which loads/creates aspect set dictionaries and converts sentences to syntactic feature
      vectors to be used in syntax-infused NMT model.
